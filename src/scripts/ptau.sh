...
snarkjs powersoftau new bn128 12 zk/ptau/pot8_0000.ptau -v
...
snarkjs powersoftau contribute zk/ptau/pot8_0000.ptau zk/ptau/pot8_0001.ptau \
    --name="First contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
snarkjs powersoftau contribute zk/ptau/pot8_0001.ptau zk/ptau/pot8_0002.ptau \
    --name="Second contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
snarkjs powersoftau contribute zk/ptau/pot8_0002.ptau zk/ptau/pot8_0003.ptau \
    --name="Third contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"

# Verify
snarkjs powersoftau verify zk/ptau/pot8_0003.ptau
...
snarkjs powersoftau beacon zk/ptau/pot8_0003.ptau zk/ptau/pot8_beacon.ptau \
...
snarkjs powersoftau prepare phase2 zk/ptau/pot8_beacon.ptau zk/ptau/pot8_final.ptau -v

# Verify the final ptau file. Creates the file pot8_final.ptau
snarkjs powersoftau verify zk/ptau/pot8_final.ptau